...
use self::token::{
    authorize_identity, constant_time_eq, generate_token, hash_token, mint_install_session,
...
impl NodeRegistry {
    ...
    pub async fn authorize(
        ...
        authorize_identity(&state.entries, identity, token, self.registry_revision())
    }
